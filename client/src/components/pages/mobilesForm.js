...
{/* <b>Hey there,</b> {user.name.split(" ")[0]} */}
        ...
        <div className='row'>
          <div className='col s12'>
            ...
            <div class="card">
              <div class="card-content">
                <span class="card-title"><h3>Add Vehicle</h3></span>
                <form>
                  ...
                  <div class="input-field col s12">
                    ...
                    <label for="specification">Engine CC</label>
                  </div>
                  <div class="input-field col s12">
                    <input type="text"  ref="internalmemory" />
                    <label for="specification">Seating Capacity</label>
                  </div>
                  <div class="input-field col s12">
                  ...
                  <div class="input-field col s12">
                    ...
                    <label for="price">Steering type</label>
                  </div>
                  <div class="input-field col s12">
                ...
                {(!this.props.msg)?("Add Vehicle"):(this.props.msg)}
          ...
          <div className='col s12'>
            ...
            <div class="card">
              <div class="card-content">
                <span class="card-title"><h3>Remove Vehicle</h3></span>
                <form >
